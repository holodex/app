...
var formatGraphData2 = require('graph-view/format-graph-data2')
...
var colaStore = Reflux.createStore({
  ...
  formatGraph: function (payload) {
    this.nodesAndLinks = formatGraphData2(payload.model, payload.queryMap, payload.queries, this.centerCoords)
    this.queryMap = payload.queryMap
  ...
  animationTick: function (graph) {
    ...
    this.nodes = graph.nodes || this.nodes
    this.queryMap = graph.queryMap || this.queryMap
