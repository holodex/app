...
var colaStore = Reflux.createStore({
  ...
  startAnimation: function (payload) {
    ...
    this.animateGraph({
      ...
      oldScale: this.scale, //existing scale -> 1
      oldNodes: this.nodes,
      oldLinks: this.links,
  ...
  onWheel: function (payload) {
    ...
    var transformed = matrixZoom(
      [this.vector[0], this.vector[1], this.scale ],
      [payload.point[0], payload.point[1], dScale ]
    )

    this.vector = transformed.slice(0, 2)
    this.scale = transformed[2]
