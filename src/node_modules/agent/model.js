  ...
  derived: {
    ...
    sourceRoles: {
      ...
      fn: function () {
        ...
        this.roles.forEach(function (role) {
          if (role.pair.agent && role.pair.agent.getId() !== agentId && role.pair.type.isSource) {
            sourceRoles.push(role.pair)
          }
        })
    ...
    targetRoles: {
      ...
      fn: function () {
        ...
        this.roles.forEach(function (role) {
          if (role.pair.agent && role.pair.agent.getId() !== agentId && role.pair.type.isTarget) {
            targetRoles.push(role.pair)
          }
        })
