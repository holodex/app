  ...
  derived: {
    ...
    sourceRoles: {
      ...
      fn: function () {
        ...
        this.roles.forEach(function (role) {
          role.relationship.roles.forEach(function (role) {
            if (role.agent && role.agent.getId() !== agentId && role.type.isSource) {
    ...
    targetRoles: {
      ...
      fn: function () {
        ...
        this.roles.forEach(function (role) {
          role.relationship.roles.forEach(function (role) {
            if (role.agent && role.agent.getId() !== agentId && role.type.isTarget) {
