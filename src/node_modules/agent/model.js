...
var filtered = require('ampersand-filtered-subcollection')
...
module.exports = Model.extend({
  ...
  initialize: function (attrs, opts) {
    ...
    this.roles = filtered(roles, {
      where: {
        agent: this
      }
    })

    this.relationships = filtered(relationships, {
      filter: function (relationship) {
        return relationship.roles.some(function (role) {
          role.agent === this
        }, this)
      }.bind(this)
    })
