...
import { getContextAgentId } from 'graph/getters'
import { getQueries } from 'query/getters'
...
export const queryReducer = (state = testState, action) => {
  const agentId = getContextAgentId(state)
  console.log('queryReducer', state, action)
  if (action.type === 'DEFAULT_QUERIES') {
