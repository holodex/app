...
module.exports = Class({
  constructor: function _BaseService_constructor (options) {
    ...
    console.log("httpConfig", options.httpConfig, httpConfig)
  ...
  urlId: function _BaseService_urlId (id) {
    ...
    id = Url.format({
      ...
      host: isProd ? this.hostname : null,
      hostname: !isProd ? this.hostname : null,
      port: (!isProd && this.port !== 80) ? this.port : null,
