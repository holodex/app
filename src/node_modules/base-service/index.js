...
module.exports = Class({
  constructor: function _BaseService_constructor (options) {
    ...
    this.host = httpConfig.hostname || "localhost";
    this.prefix = stripSlashes(httpConfig.pathname || "");
  ...
  urlId: function _BaseService_urlId (id) {
    ...
    id = Url.format({
      ...
      host: this.host,
      pathname: Path.join(this.prefix, this.collection, id || "")
    });
  ...
  get: function _BaseService_get (id, params, cb) {
    ...
    return this.storage.get(id, params, function (err, obj) {
      if (err) { return cb(err); }
