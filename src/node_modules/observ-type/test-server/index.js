...
test('type and version', function (t) {
  ...
  t.deepEqual(resource.getType(), ["Resource"])
...
test('props', function (t) {
  ...
  assertObs(t, thing, defaultProps)
...
test('multiple instances', function (t) {
  ...
  t.equal(one.get('name')(), 'a')
  t.equal(two.get('name')(), undefined)
...
test('extend model', function (t) {
  ...
  t.deepEqual(simpleThing.getType(), ["SimpleThing"])
...
function assertObs (t, obs, expected) {
