...
test('model relations', function (t) {
  var Thing = createType({
    graph: 'things',
    props: {
      name: Observ(),
  ...
  context.atom = ObservGraph(context)
  ...
  t.equal(atom.getLength(), 0)

  context.atom.push(agent)

  t.equal(atom.getLength(), 1)
  t.equal(atom.things.getLength(), 1)
  t.equal(atom.agents.getLength(), 1)

  t.deepEqual(atom.get(0)(), agent)
  t.deepEqual(atom.agents.get(0)(), agent)
  t.deepEqual(atom.things.get(0)(), agent)
