...
function getDefaultTripleFormat (model) {
  if (model['@type'] === 'Group') {
    ...
    var defaultTripleFormat = { linkTypeId: member + '/link', roleType: member, relationshipTypeId: membership, expression: 'subject', isPlural: true, index: 0, type: 'Role'  }
...
function formatTriple (model, tripleFormat) {
  ...
  triple[tripleFormat.expression] = {
    relationshipTypeId: tripleFormat.relationshipTypeId,
