  ...
  model.roles.forEach(function (role) {
    if (
      ...
      options.push({
        ...
        label: role.type.linkType.label.format({ source: model.name })
      })
    ...
    if (
      ...
      if (
        ...
        options.push({
          ...
          label: sourceRole.type.linkType.label.format({ target: model.name })
        })
    ...
    if (
      ...
      if (
        ...
        options.push({
          ...
          label: targetRole.type.linkType.target.format({ target: model.name })
        })
