...
var parseQueryString = require('./parse-querystring')
...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    var activeQueries = parseQueryString(this.props.route.query, this.props.model)
    var queries = getQueries(this.props.model, activeQueries)
    debug('queries', queries, activeQueries)
