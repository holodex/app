...
module.exports = React.createClass({
  ...
  onRouteUpdate: function (payload) {
    if (!payload.route) { this.setState({ queries: payload.queries }) }
  },
  ...
  render: function () {
    ...
    active.forEach(function (query) {
      ...
      var tag = r.div({ className: 'tag', style: this.style.contextTag }, [
        iconDiv,
        r(Tag, {
          data: label,
          color: label.color,
      ...
      if (!query.showHalo && !query.showLink) { headerTags.push(tag) }
    ...
    return r.div({ className: 'tags', style: this.style.index }, [
      ...
      this.state.queries.inactive.length > 0 ? r.div({ className: 'tag-input', style: this.style.tagInputContainer }, [
        r(TagSelect, {
