...
module.exports = React.createClass({
  ...
  propTypes: {
    ...
    handleAgentHover: React.PropTypes.func
  },
                  ...
                  return r(Node,
                    {
                      ...
                      handleMouseOver: this.props.handleAgentHover(node.data, [node.x, node.y], node.w)
                    }
                  )
                }.bind(this))
              ]
