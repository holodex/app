...
module.exports = React.createClass({
  ...
  propTypes: {
    ...
    handleAgentMouseOver: React.PropTypes.func,
    handleAgentMouseOut: React.PropTypes.func,
  },
  ...
  render: function () {
    ...
    debug('state', this.state, this.props)
                  ...
                  return r(Node,
                    {
                      ...
                      handleMouseOver: this.props.handleAgentMouseOver(node.data, node.w),
                      handleMouseOut: this.props.handleAgentMouseOut(node.data),
