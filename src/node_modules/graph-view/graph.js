...
module.exports = React.createClass({
  ...
  getInitialState: function (options) {
    ...
    var filtersByType = filtersStore.getFiltersByType()

    return {
      nodes: colaStore.getNodes(),
      links: colaStore.getLinks(),
      filters: filtersByType ? filtersByType.targetAgent.concat(filtersByType.context) : []
    }
  },
  ...
  onFiltersUpdate: function (update) {
    this.setState({ filters: update.filtersByType.targetAgent.concat(update.filtersByType.context) })
  },
