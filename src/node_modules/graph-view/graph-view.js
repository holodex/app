...
module.exports = React.createClass({
  ...
  render: function () {
    debug('state', this.state.focusAgent)
    var cancelIcon = r(
      this.props.Icon,
    ...
    var props = extend(this.props, {
      ...
      handleAgentHover: this.handleAgentHover
    })
    ...
    var tooltipCoords = [
      this.state.focusAgent.coords[0] +
        this.state.focusAgent.size +
        this.context.muiTheme.spacing.desktopGutterMini,
      this.state.focusAgent.coords[1] +
        this.state.focusAgent.size +
        this.context.muiTheme.spacing.desktopGutterMini
    ]
    ...
    r.div({
        ...
        this.state.showTooltip ? r(Tooltip, {
          data: this.state.focusAgent.data,
  ...
  handleAgentHover: function (data, size) {
    var self = this
