...
function nodeInSubject (node, triple) {
  ...
  if (subject.active && subject.agentType === node.data['@type']) { //matching agentType
    debug('subject agentType', subject.agentType, node.data['@type'])
...
module.exports = function (model, tagData, centerCoords, options) {
  ...
  graph.forEachNode(function (node) {
    ...
    //allow pre-placement of nodes through the options argument
  ...
  graph.forEachLink(function (link) {
    ...
    var isLinkToParent = linkIsToParentGroup(link, contextAgentId)
    if (isLinkToParent) {
      debug('isLinkToParent', source, target, vars.colors.mediumGray)
