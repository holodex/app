...
module.exports = React.createClass({
  render: function () {
    ...
    var arrowLength = c - targetR - sourceR - 3
    ...
    var path = Path()
      .moveto(d.source.x-1, d.source.y-sourceR)
      .lineto(d.source.x-1, d.source.y-arrowLength)
      .lineto(d.source.x-3, d.source.y-arrowLength)
      .lineto(d.source.x, d.source.y-arrowLength-4)
      .lineto(d.source.x+3, d.source.y-arrowLength)
      .lineto(d.source.x+1, d.source.y-arrowLength)
      .lineto(d.source.x+1, d.source.y-sourceR)
      .closepath()
