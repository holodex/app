...
const state = assign(data, {
  ...
  queryTypes: [
    ...
    {
      id: 'is-member-of/group/source',
      relationshipType: 'is-member-of',
      agentType: 'Group',
      direction: 'source',
      labels: ['Groups that {source} is a member of']
    },
    {
    ...
    {
      id: 'mentors/person/source',
      relationshipType: 'mentors',
      agentType: 'Person',
      direction: 'source',
      label: [ 'People mentored by {source}' ]
    }


  ],
  graph: { queries: [], nodes: [], shouldUpdate: true }
})
