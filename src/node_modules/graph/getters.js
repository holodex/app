...
export const getLinks = state => state.graph.links
export const getGroups = state => state.graph.groups
...
export const getContextAgentId = state => state.graph.agentId

export const getQueries = createSelector(
  [querieById],
  queriesById => map(queriesById)
)
