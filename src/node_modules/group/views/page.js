...
module.exports = React.createClass({
  ...
  renderGraph: function () {
    ...
    console.log("nodes", model.relatedNodes);
    console.log("edges", model.relatedEdges);

    // TODO entities
    var entities = [];
    var predicates = this.state.predicates.map(function (pred) { this.state.prefix + pred }.bind(this));
    // TODO actions
    var actions = [];
