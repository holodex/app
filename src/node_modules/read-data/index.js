...
var parseInput = require('parse-input-stream')
...
var debug = require('debug')('holodex:read-data')
  ...
  var parsers = {
    ...
    LinkType: function parseLinkType (attrs) {
      return assign(attrs, {
        ...
        inverse: 'linkTypes/' + attrs.inverse
      })
    },
    Relationship: function parseRelationship (attrs) {
      ...
      var sourceRole = Model.new({
        ...
        relationship: 'relationships/' + relId
      })
      ...
      return {
        ...
        context: attrs.context && findAgent(attrs.context).getId()
      }
    }
  }
